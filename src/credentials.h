...
const char* busStopLatLng = "longitude,latitude"; 

const char* originStopLatLng = "longitude,latitude"; //Your bus stop
...
const char* destStopLatLng = "longitude,latitude"; //Next stop